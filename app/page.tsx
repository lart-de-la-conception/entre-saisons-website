...
export default function Home() {
  return (
    <main className="min-h-[calc(100svh-68px)] overflow-x-hidden bg-white md:h-[calc(100svh-68px)] md:overflow-hidden">
      <div className="relative h-full w-full px-4 pt-4 pb-20 sm:px-6 sm:pt-2">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="relative z-10 mx-auto w-full max-w-2xl">
            ...
            <Link
              href="/products"
              className="mt-4 inline-block text-[11px] font-thin text-black hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-black/20 rounded-sm md:absolute md:left-full md:top-1/2 md:mt-0 md:-translate-y-1/2 md:pl-12"
            >
